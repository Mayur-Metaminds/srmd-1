  ...
  return (
    <section className="mt-24 relative w-full py-12  px-4 sm:px-6 md:px-12 lg:px-20 overflow-hidden ">
      ...
      <div className="w-[90%] sm:w-full   mb-5 flex  items-start flex-col  ">
        <div className=" w-full lg:w-[22%] xl:w-[22%] max-w-4xl bg-[#1D2B53] text-white  text-[12px]  sm:text-[16px] font-semibold   py-3 rounded-full mb-4 flex  gap-x-1  sm:px-3 justify-center">
