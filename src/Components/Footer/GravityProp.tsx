        ...
        <motion.div className="w-dvw h-dvh flex flex-col relative bg-transparent opacity-70  sm:opacity-100" ref={ref}>
            ...
            >
                <MatterBody matterBodyOptions={{ friction: 0.5, restitution: 0.5 }} x="80%" y="0%">
                    <img src="/footer/ladder.svg" alt="" className="hover:cursor-grab w-20 h-20" />

                </MatterBody>
                <MatterBody matterBodyOptions={{ friction: 0.5, restitution: 0.5 }} x="85%" y="0%" angle={10}>

                    <img src="/footer/circle.svg" alt="" className="hover:cursor-grab w-20 h-20" />

                </MatterBody>
                <MatterBody matterBodyOptions={{ friction: 0.5, restitution: 0.5 }} x="83%" y="0%">

                    <img src="/footer/chakra.svg" alt="" className="hover:cursor-grab w-20 h-20" />

                </MatterBody>
                <MatterBody matterBodyOptions={{ friction: 0.5, restitution: 0.5 }} x="82%" y="0%">
                    <img src="/footer/4line.svg" alt="" className="hover:cursor-grab w-20 h-20 sm:w-32 sm:h-32" />

                </MatterBody>
                <MatterBody matterBodyOptions={{ friction: 0.5, restitution: 0.5 }} x="81%" y="0%">

                    <img src="/footer/flower.svg" alt="" className="hover:cursor-grab w-20 h-20" />
