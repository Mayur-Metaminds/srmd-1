...
export default function TimeLineSection() {
    return (
        <>
            ...
            >
                <svg width="1139" height="216" viewBox="0 0 1139 216" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-20 left-10 -z-20">
                    <path d="M33.7621 194.123C27.5745 190.37 24.3159 188.978 20.3728 192.913C21.3376 187.415 19.2319 185.216 12.0632 182.429C7.88271 189.007 7.63391 191.934 10.8335 195.834C5.37523 194.894 3.201 196.987 0.416361 204.041C7.31332 208.664 10.0066 208.449 13.6733 205.344C12.7151 211.543 15.8674 213.163 22.1153 215.734C26.1088 209.312 26.932 206.163 22.8601 202.315C29.0922 203.352 31.048 200.633 33.7621 194.123Z" fill="#15A9EE" fillOpacity="0.4" />
    ...
    return (
        ...
        >
            ...
            <div className="relative h-[390px] w-full overflow-hidden  lg:h-[65vh]  border-b-4  mt-10 border-dotted  border-b-white   ">
                <div className="scrollable-container flex w-fit gap-[140px] px-[calc(50%-calc(650px/2))] lg:gap-[190px] z-20  "
