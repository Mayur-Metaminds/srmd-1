  ...
  return (
    ...
    >
      <svg width="1282" height="549" viewBox="0 0 1282 549" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-[-12px] left-0 w-[100vw] h-auto max-w-none z-10">
        ...
        <circle cx="12.6" cy="12.6" r="12.6" transform="matrix(-1 0 0 1 438.199 84.0078)" fill="#BA8C2D" />
        <rect x="1249.74" y="492.381" width="15.7799" height="6.36088" transform="rotate(-130.1 1249.74 492.381)" fill="#BA8C2D" />
        <rect x="1236.42" y="491.271" width="15.7799" height="6.36088" transform="rotate(-130.1 1236.42 491.271)" fill="#BA8C2D" />
        <rect x="1235.17" y="480.014" width="15.7799" height="6.36088" transform="rotate(139.9 1235.17 480.014)" fill="#BA8C2D" />
        <rect x="1248.49" y="481.115" width="15.7799" height="6.36088" transform="rotate(139.9 1248.49 481.115)" fill="#BA8C2D" />
