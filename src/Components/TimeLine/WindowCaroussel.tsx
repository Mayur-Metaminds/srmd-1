...
// // // import { TimeLineTop } from "./TimeLineSection"
...
// // import { useParallax, useParallaxx } from "@/hooks/paralllelx"
// // import { motion } from 'framer-motion';
// // // REMOVE body-scroll-lock imports - parent handles this now
...
// // const moveToNextSection = () => {
// //     // First unlock the scroll by triggering parent's isInView = false
// //     setIsInView(false)
    
// //     // Small delay to allow scroll restoration
// //     setTimeout(() => {
// //         const nextSection = document.querySelector("#contact")
// //         if (nextSection) {
// //             nextSection.scrollIntoView({ behavior: "smooth" })
...
// //     // KEEP IntersectionObserver but ONLY for tracking visibility
// //     useEffect(() => {
// //         if (!containerRef.current) return
...
// //     // GSAP Observer - parent handles scroll lock, this just manages carousel navigation
// //     useEffect(() => {
// //         if (!isInView || !containerRef.current) return
...
// //             wheelSpeed: -1,
// //             tolerance: 10,
// //             preventDefault: true, // Let GSAP handle prevention
// //             onUp: () => {
// //                 scrollDirection.current = "down"
// //                 if (animating || !timeLineData) return
// //                 const total = timeLineData.length
...
// //         updateIndex(currentIndex - 1)
// //     } else {
// //         // At first card - exit to previous section
// //         observerRef.current?.kill()
// //         setIsInView(false) // Unlock scroll
...
// //     // REMOVE all disableBodyScroll/enableBodyScroll calls
// //     // REMOVE all preventDefault event listeners
...
// >>>>>>> 7fb5c36ea4b33e813fda9c119451e5a13ede26e2
// gsap.registerPlugin(Observer)
...
//         ease: "power3.out", // Changed from "linear" to smooth ease
//             onComplete: () => setAnimating(false),
//         })
