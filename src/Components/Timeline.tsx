...
export default function Timeline() {
  ...
  const handleWheel = (e:any) => {
    ...
    return (
        <div
            id="count-down"
            className="w-full flex flex-col items-center mt-4 sm:mt-6 lg:mt-10 min-h-[400px] sm:min-h-[500px] lg:h-[804px] xl:h-[804px] p-4 sm:p-6 lg:p-8 gap-4 sm:gap-6 lg:gap-10 justify-start sm:justify-center relative overflow-hidden rounded-bl-[0%]"
