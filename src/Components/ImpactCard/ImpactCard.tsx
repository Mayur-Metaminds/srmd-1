...
import { BgLeftProp } from "./BgLeftProp";
import { BgRightProp } from "./BgRightProp";
...
export default function ImpactCard() {
  ...
  return (
    <div
      className=" mt-1  min-h-screen flex-col flex items-center  p-4 relative overflow-x-clip overflow-y-visible w-full gap-y-1  "
    >
      <motion.div
        className="absolute  left-2 top-5 h-[65%] -z-30">
        <BgLeftProp />
      </motion.div>
{/* 
      <motion.svg

        className="absolute   right-10 top-1 h-[65%]  z-30"
      ...
      <div className="w-full text-[12px] sm:text-[16px] font-semibold  self-justify-start  mt-32">
        <div className="w-fit p-3 px-5 rounded-[100px] min-w-[167.68px] min-h-[43px]  bg-[#293464] text-white flex justify-center items-center gap-2 mx-auto mb-10 ">
...
//       </mask>
//       <g mask="url(#mask0_208_82)">
//         <rect x="-5.15625" y="231.164" width="37.0635" height="37.8571" fill="#BA8C2D" />
//       </g>
