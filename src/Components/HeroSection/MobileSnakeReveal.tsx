...
export function MobileSnakeReveal() {
  ...
  const { ref: ref44, y: y44 } = useParallax({ speed: 0.5 });
  ...
  return (
    <motion.div
      ref={ref}
      className="block sm:hidden w-full h-auto -mt-8 mb-4 absolute top-[300px] opacity-60"
    //   initial={{ opacity: 0 }}
    ...
    >
      <svg
        ...
        className="w-full h-auto  overflow-y-visible overflow-x-clip"
      >
        <defs>
        ...
        <motion.path d="M-26 145.5C-26 145.5 164 20.3053 244.5 116.298C325 212.29 497 79 497 79" stroke="#FED543" strokeWidth="32" clipPath="url(#MobilesnakeClip)"
          ref={(el) => {
            ref55.current = el
          }}
          style={{ y: y55 }}
