  ...
  return (
    <>
      ...
      >
        ...
        >
          <path d="M280.382 44.8317L290.411 60.852L296.473 43.9034L301.183 44.6186L302.429 62.6769L315.787 50.2075L319.334 53.1062L311.11 70.0638L329.227 66.7457L331.137 70.5759L316.893 81.2249L332.721 87.5055L331.908 91.765L313.33 92.6529L325.533 107.486L322.521 110.906L306.257 102.031L309.102 120.5L304.803 122.545L295.724 106.837L289.174 123.712L284.464 122.997L283.705 105.013L269.398 117.169L266.225 113.99L274.749 97.2468L256.096 100.82L254.722 96.7346L270.454 86.1428L252.977 79.7804L253.627 75.4962L272.23 74.4435L260.327 59.8243L263.151 56.5444L279.603 65.2798L276.458 46.596L280.382 44.8317Z" fill="#C8AD6E" />
          <path d="M219.073 74.8789L225.843 85.6927L229.935 74.2524L233.114 74.7351L233.955 86.9245L242.972 78.5076L245.366 80.4643L239.815 91.9106L252.044 89.6709L253.333 92.2563L243.718 99.4444L254.402 103.684L253.853 106.559L241.313 107.158L249.55 117.171L247.518 119.479L236.539 113.488L238.459 125.955L235.558 127.335L229.429 116.733L225.008 128.123L221.829 127.64L221.317 115.501L211.659 123.707L209.518 121.561L215.271 110.259L202.68 112.671L201.753 109.913L212.372 102.764L200.575 98.4694L201.014 95.5775L213.571 94.867L205.536 84.999L207.442 82.7851L218.548 88.6814L216.425 76.0699L219.073 74.8789Z" fill="#1CB377" />
          <path d="M1003.25 81.7083L1013.26 93.3542L1016.06 79H1019.94L1023.14 93.3542L1032.35 81.7083L1035.55 83.6042L1031.01 98.2292L1045.16 93.3542L1047.16 96.1979L1037.02 106.49L1050.5 109.604L1050.37 113.125L1035.55 116.104L1047.16 126.531L1045.16 129.646L1031.01 124.5L1035.55 138.99L1032.35 141.156L1023.14 129.646L1019.94 144H1016.06L1013.26 129.646L1003.25 141.156L1000.32 138.99L1005.12 124.5L990.572 129.646L988.97 126.531L1000.32 116.104L985.5 113.125V109.604L1000.32 106.49L988.97 96.1979L990.839 93.2188L1005.12 98.2292L1000.32 83.6042L1003.25 81.7083Z" fill="#0B5399" />
...
function VideoSection() {
  ...
  return (
    <motion.div className="w-[95%] sm:w-[92%] lg:w-[90%] border-[10px] border-[#C8AD6E] rounded-2xl m-auto flex justify-center items-center h-[300px] sm:h-[400px] md:h-[500px] lg:h-[657px] overflow-hidden relative z-10 mb-10 
    "
      ref={ref}
      initial={{ opacity: 0, scale: 0.9 }}
      animate={isInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.9 }}
