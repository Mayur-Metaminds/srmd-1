...
export default function CountDown() {
    return (
        <>
            <div id="count-down" className="w-full m-auto border- flex flex-col items-center mt-10 h-[621px] p-2 gap-10 justify-center relative" style={{background:"linear-gradient(#293464B2), url('/countdownbg.jpg')"}}>
            <svg width="1282" height="549" viewBox="0 0 1282 549" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute top-[-12px]">
...
<rect x="601.77" y="545.43" width="25.1988" height="4.02024" transform="rotate(-34.703 601.77 545.43)" fill="#95A4E6" fillOpacity="0.4"/>
                ...
                <AnimatedNumberCountdown
                    ...
                    compactPreview={true}
                />
                <div className="text-white flex flex-col items-center w-1/2 gap-1 text-[37px]">
                    <div className="flex gap-3 justify-center items-center">
                        <CalendarDays  width={37} height={37}/>
                    <span>Sunday,16 November, 2025</span>
                    </div>
                     <div className="flex gap-3 justify-center items-center">
                        <MapPin width={37} height={37} />
                    <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. In, repellat.</span>
                    </div>
                </div>

                <button className="bg-[#FED543]  rounded-md hover:scale-95 duration-500 w-[240px] h-[52px]  font-bold z-100">
                   <span> Know More</span>
                </button>
